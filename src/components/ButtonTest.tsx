...
function ButtonTest (props: IButtonPage) {
  ...
  const btnStartPage = document.querySelector('.btn-start') as HTMLButtonElement;;
  const btnPrevious = document.querySelector('.btn-previous') as HTMLButtonElement;;
  ...
  return (
    <div className="pagination">
        <div className='page btn-start' onClick={() => getStartPage(1)}>{'<<'}</div>
        <div className='page btn-previous' onClick={() => decrementPage(props.page)}>{'<'}</div>
        <div className='page'>{`${props.page}`}</div>
        <button className='page active-pagination next-page' onClick={() => incrementPage(props.page)}>{'>'}</button>
        <button className='page active-pagination last-page' onClick={() => getLastPage(props.itemAllPages)}>{'>>'}</button>
        <select className='page active-pagination' id="mySelect" name="options" onChange={handleSelectChange}>
        <option className='page active-pagination' value="10">10</option>
        <option className='page active-pagination' value="20">20</option>
        <option className='page active-pagination' value="30">30</option>
        </select>
    </div>
  );
